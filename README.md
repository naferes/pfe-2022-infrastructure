...
```
cd existing_repo
git remote add origin https://gitlab.com/nferes/pfe-2022-infrastructure.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/nferes/pfe-2022-infrastructure/-/settings/integrations)
